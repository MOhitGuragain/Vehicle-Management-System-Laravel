...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-4 md:p-8">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-3xl font-bold mt-2">{{ $activeRentals ?? 0 }}</h2>
                </div>
            ...
            <div class="mt-4 pt-4 border-t border-white/20">
                <p class="text-sm text-blue-100">
                    {{ $activeRentalsMessage ?? 'Currently no active rentals' }}
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mt-2">{{ $upcomingBookings ?? 0 }}</h2>
                </div>
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
                <p class="text-xs text-gray-500">
                    {{ $upcomingBookingsMessage ?? 'No upcoming bookings' }}
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mt-2">{{ $totalRentals ?? 0 }}</h2>
                </div>
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
                <p class="text-xs text-gray-500">Track all your rentals</p>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-3xl font-bold mt-2">{{ $loyaltyPoints ?? 0 }}</h2>
                </div>
                <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
    ...
    <!-- Rest of your Quick Actions, Promo, Quick Links, and Footer Section here... -->
    <!-- Quick Actions -->
    <div class="mb-10">
    ...
    <!-- Everything else from your existing template can remain unchanged -->
</div>
@endsection